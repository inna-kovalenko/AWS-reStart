...
*   **Baseline Estimate**: Calculated the "Before Optimization" cost including the `t3.small` instance and 20 GB of storage.
*   **Optimized Estimate**: Generated an "After Optimization" model reflecting the smaller instance and reduced storage.
*   **Savings Reporting**: Identified a projected monthly cost saving.
